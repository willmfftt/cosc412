...
/**
 * Base class that represents a row from the 'refund' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Refund implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\RefundTableMap';
    ...
    /**
     * Initializes internal state of Base\Refund object.
     */
    ...
    /**
     * Compares this with another <code>Refund</code> instance.  If
     * <code>obj</code> is an instance of <code>Refund</code>, delegates to
     * <code>equals(Refund)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Refund The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RefundTableMap::COL_ID] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[RefundTableMap::COL_AMOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 3; // 3 = RefundTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Refund'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRefundQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Refund::setDeleted()
     * @see Refund::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRefundQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RefundTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = RefundTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Refund'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildRefundQuery::create();
        $criteria->add(RefundTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Refund (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Refund Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(RefundTableMap::DEFAULT_STRING_FORMAT);
    }
