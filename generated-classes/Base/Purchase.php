...
abstract class Purchase implements ActiveRecordInterface
{
    ...
    public function setTransactionid($v)
    {
        ...
        if ($this->transactionid !== $v) {
            ...
            $this->modifiedColumns[PurchaseTableMap::COL_TRANSACTIONID] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PurchaseTableMap::COL_TRANSACTIONID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PurchaseTableMap::COL_TRANSACTIONID)) {
            $criteria->add(PurchaseTableMap::COL_TRANSACTIONID, $this->transactionid);
        }
        if ($this->isColumnModified(PurchaseTableMap::COL_AMOUNT)) {
