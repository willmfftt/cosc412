...
abstract class Purchase implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PurchaseTableMap';
    ...
    /**
     * Initializes internal state of Base\Purchase object.
     */
     ...
     * @return $this|\Purchase The current object (for fluent API support)
     */
    ...
    public function setTransactionId($v)
    {
        ...
        if ($this->transaction_id !== $v) {
            ...
            $this->modifiedColumns[PurchaseTableMap::COL_TRANSACTION_ID] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[PurchaseTableMap::COL_AMOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PurchaseTableMap::translateFieldName('TransactionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transaction_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PurchaseTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = PurchaseTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Purchase'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PurchaseTableMap::COL_TRANSACTION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'transaction_id';
        }
        if ($this->isColumnModified(PurchaseTableMap::COL_AMOUNT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PurchaseTableMap::COL_TRANSACTION_ID)) {
            $criteria->add(PurchaseTableMap::COL_TRANSACTION_ID, $this->transaction_id);
        }
        if ($this->isColumnModified(PurchaseTableMap::COL_AMOUNT)) {
            $criteria->add(PurchaseTableMap::COL_AMOUNT, $this->amount);
        }
    ...
    public function getTransaction(ConnectionInterface $con = null)
    {
        if ($this->aTransaction === null && ($this->transaction_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTransaction->addPurchases($this);
             */
        }
    ...
    {
        if (null !== $this->aTransaction) {
            $this->aTransaction->removePurchase($this);
        }
        $this->id = null;
