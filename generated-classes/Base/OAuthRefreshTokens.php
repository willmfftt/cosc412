...
abstract class OauthRefreshTokens implements ActiveRecordInterface
{
    ...
    public function getExpires($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->expires instanceof \DateTime ? $this->expires->format($format) : null;
        }
    }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'user_id':
                        ...
                        break;
                    case 'expires':
                        $stmt->bindValue($identifier, $this->expires ? $this->expires->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                    case 'scope':
    ...
    {
        $validPk = null !== $this->getRefreshToken();
