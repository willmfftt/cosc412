...
*/
abstract class Budget implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BudgetTableMap';
    ...
    /**
     * Initializes internal state of Base\Budget object.
     */
    ...
    /**
     * Compares this with another <code>Budget</code> instance.  If
     * <code>obj</code> is an instance of <code>Budget</code>, delegates to
     * <code>equals(Budget)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Budget The current object, for fluid interface
     */
     ...
     * @return $this|\Budget The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BudgetTableMap::COL_ID] = true;
        }
    ...
    public function setLocationId($v)
    {
        ...
        if ($this->location_id !== $v) {
            $this->location_id = $v;
            $this->modifiedColumns[BudgetTableMap::COL_LOCATION_ID] = true;
        }
    ...
    public function setBranchId($v)
    {
        ...
        if ($this->branch_id !== $v) {
            $this->branch_id = $v;
            $this->modifiedColumns[BudgetTableMap::COL_BRANCH_ID] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[BudgetTableMap::COL_AMOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BudgetTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BudgetTableMap::translateFieldName('LocationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->location_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BudgetTableMap::translateFieldName('BranchId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->branch_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BudgetTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = BudgetTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Budget'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBudgetQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBudgetQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BudgetTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BudgetTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(BudgetTableMap::COL_LOCATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'location_id';
        }
        if ($this->isColumnModified(BudgetTableMap::COL_BRANCH_ID)) {
            $modifiedColumns[':p' . $index++]  = 'branch_id';
        }
        if ($this->isColumnModified(BudgetTableMap::COL_AMOUNT)) {
    ...
    {
        $pos = BudgetTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Budget'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Budget'][$this->hashCode()] = true;
        $keys = BudgetTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BudgetTableMap::COL_ID)) {
            $criteria->add(BudgetTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(BudgetTableMap::COL_LOCATION_ID)) {
            $criteria->add(BudgetTableMap::COL_LOCATION_ID, $this->location_id);
        }
        if ($this->isColumnModified(BudgetTableMap::COL_BRANCH_ID)) {
            $criteria->add(BudgetTableMap::COL_BRANCH_ID, $this->branch_id);
        }
        if ($this->isColumnModified(BudgetTableMap::COL_AMOUNT)) {
            $criteria->add(BudgetTableMap::COL_AMOUNT, $this->amount);
        }
    ...
    {
        $criteria = ChildBudgetQuery::create();
        $criteria->add(BudgetTableMap::COL_ID, $this->id);
    ...
    public function getLocation(ConnectionInterface $con = null)
    {
        if ($this->aLocation === null && ($this->location_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLocation->addBudgets($this);
             */
        }
    ...
    {
        if (null !== $this->aLocation) {
            $this->aLocation->removeBudget($this);
        }
        if (null !== $this->aBranch) {
            $this->aBranch->removeBudget($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(BudgetTableMap::DEFAULT_STRING_FORMAT);
    }
