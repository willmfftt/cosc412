...
class AdminTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID, AdminTableMap::COL_USERID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID => 0, AdminTableMap::COL_USERID => 1, ),
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AdminTableMap::COL_USERID);
        } else {
