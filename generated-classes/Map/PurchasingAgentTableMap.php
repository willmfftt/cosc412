...
/**
 * This class defines the structure of the 'purchasing_agent' table.
 *
 *
 *
 ...
 *
 */
class PurchasingAgentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PurchasingAgentTableMap';
     ...
     */
    const TABLE_NAME = 'purchasing_agent';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\PurchasingAgent';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PurchasingAgent';
     ...
     */
    const COL_ID = 'purchasing_agent.id';
    ...
    {
        // attributes
        $this->setName('purchasing_agent');
        $this->setPhpName('PurchasingAgent');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\PurchasingAgent');
        $this->setPackage('');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \PurchasingAgent $obj A \PurchasingAgent object.
     ...
     *
     * @param mixed $value A \PurchasingAgent object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \PurchasingAgent) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \PurchasingAgent object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? PurchasingAgentTableMap::CLASS_DEFAULT : PurchasingAgentTableMap::OM_CLASS;
    }
     ...
     * @return array           (PurchasingAgent object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = PurchasingAgentTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = PurchasingAgentTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + PurchasingAgentTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PurchasingAgentTableMap::OM_CLASS;
            /** @var PurchasingAgent $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            PurchasingAgentTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = PurchasingAgentTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = PurchasingAgentTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(PurchasingAgentTableMap::DATABASE_NAME)->getTable(PurchasingAgentTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(PurchasingAgentTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(PurchasingAgentTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new PurchasingAgentTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a PurchasingAgent or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or PurchasingAgent object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PurchasingAgent) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(PurchasingAgentTableMap::COL_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(PurchasingAgentTableMap::COL_USER_ID, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = PurchasingAgentQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            PurchasingAgentTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                PurchasingAgentTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return PurchasingAgentQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a PurchasingAgent or Criteria object.
     *
     * @param mixed               $criteria Criteria or PurchasingAgent object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from PurchasingAgent object
        }

        if ($criteria->containsKey(PurchasingAgentTableMap::COL_ID) && $criteria->keyContainsValue(PurchasingAgentTableMap::COL_ID) ) {
...
} // PurchasingAgentTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
PurchasingAgentTableMap::buildTableMap();
