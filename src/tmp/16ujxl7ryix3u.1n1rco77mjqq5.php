...
<head>
    ...
    <!-- Timeline CSS -->
	<link href="<?php echo $BASE; ?>/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
	<link href="<?php echo $BASE; ?>/css/sb-admin-2.css" rel="stylesheet">
...
<body>
	...
	<script src="<?php echo $BASE; ?>/js/morris-data.js"></script>
    
	<script src="<?php echo $BASE; ?>/js/index.js"></script>

    <!-- Custom Theme JavaScript -->
	<script src="<?php echo $BASE; ?>/js/sb-admin-2.js"></script>
